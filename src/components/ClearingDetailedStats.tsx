...
const ClearingDetailedStats = () => {
  ...
  return (
    <Box padding="16px" paddingY="32px" minH="100dvh" background="gray.900" color="white">
      ...
      <Box mt="16px" p={3} borderRadius="16px" bg="whiteAlpha.100" border="1px solid" borderColor="whiteAlpha.200" backdropFilter="blur(8px)">
        <Text fontFamily="Geist" color="whiteAlpha.700">
          Add your past 7 days score list here.
        </Text>
      </Box>
    </Box>
  )
...
export default ClearingDetailedStats
